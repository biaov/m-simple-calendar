...
export const useShow = ({ visible }, initData) => {
  /**
   * 销毁开关
   */
 ...
 * 操作
 */
export const useHandle = ({ props, emit, modelValue, visible }) => {
  const curDate = ref({
    y: 0,
    m: 0,
    d: 0
